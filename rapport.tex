...
\todo{Point de mis parcours, organisation, planning 2, agilité pas mise en place = transition}
...
\todo{Role du manager et prise de décision collective}
\todo{Documentation?}
\todo{Intégration du client}
\todo{Formation des membres de l'équipe et autonomie}
