...
Ce projet est voué à être repris et à évoluer dans le futur, soit par des alternants de IMT Atlantique, soit par des développeurs intéressés par le sujet au sein de la \gls{DGFiP}. J'espère que ces futures évolutions permettront l'adoption de ce projet au sein des équipes de développement. Cette initiative mettrait en avant la valeur de l'innovation et des technologies modernes pour les projets de la DGFiP.
